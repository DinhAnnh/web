...
<div class="nav">
        ...
        <a href="view_food.php" class="active">Đồ ăn</a>
        <a href="upload_image.php">Tải lêm</a>
 ...
 ?>         
        <tr>
                ...
                <td>
				<a href="editImage.php?food_id=<?php echo $row['food_id']; ?>" class="edit_btn" >Sửa</a>
			    </td>
			    <td>
				<a href="deleteFood.php?food_id=<?php echo $row['food_id']; ?>" class="del_btn">Xóa</a>
			    </td>
            </tr>
<?php
        }
