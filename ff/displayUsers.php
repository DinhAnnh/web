...
<body>
    <div class="nav">
        ...
        <a href="view_food.php">Đồ ăn</a>
        <a href="upload_image.php">Tải lên</a>
        <a href="index1.html" class="active">Trang chủ</a>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?customer_id=<?php echo $row['customer_id']; ?>" class="edit_btn">Sửa</a>
                    </td>
                    <td>
                        <a href="delete.php?customer_id=<?php echo $row['customer_id']; ?>" class="del_btn">Xóa</a>
                    </td>
                </tr>
            <?php
            }
